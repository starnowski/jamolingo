package com.github.starnowski.jamolingo.core.utils;
...
public class Constants {
   ...
   * adds a level. <a
   * href="https://www.mongodb.com/docs/manual/reference/limits/?atlas-class=general&atlas-provider=aws#mongodb-limit-Nested-Depth-for-BSON-Documents">...</a>
   */
