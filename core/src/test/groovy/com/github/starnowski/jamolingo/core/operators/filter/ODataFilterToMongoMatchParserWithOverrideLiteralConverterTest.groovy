...
class ODataFilterToMongoMatchParserWithOverrideLiteralConverterTest extends AbstractSpecification {
    ...
    static oneToOneEdmPathsMappings() {
        [
                ...
                [ "tags/all(t:startswith(t,'custom_string(starlord)') or t in ('custom_string(star trek)', 'custom_string(star wars)'))", """{"\$match": {"\$and": [{"\$expr": {"\$eq": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$or": [{"\$regexMatch": {"input": "\$\$t", "regex": "^\\\\Qstarlord\\\\E"}}, {"\$in": ["\$\$t", ["star trek", "star wars"]]}]}}}}, {"\$size": {"\$ifNull": ["\$tags", []]}}]}}]}}""", ["tags"]],
                [ "tags/all(t:contains(t,'custom_string(starlord)') or contains(t,'custom_string(trek)') or contains(t,'custom_string(wars)'))", """{"\$match": {"\$and": [{"\$expr": {"\$eq": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$or": [{"\$or": [{"\$regexMatch": {"input": "\$\$t", "regex": "\\\\Qstarlord\\\\E"}}, {"\$regexMatch": {"input": "\$\$t", "regex": "\\\\Qtrek\\\\E"}}]}, {"\$regexMatch": {"input": "\$\$t", "regex": "\\\\Qwars\\\\E"}}]}}}}, {"\$size": {"\$ifNull": ["\$tags", []]}}]}}]}}""", ["tags"]],
                [ "tags/all(t:contains(t,'custom_string(starlord)'))", """{"\$match": {"\$and": [{"tags": {"\$not": {"\$elemMatch": {"\$not": {"\$regex": "\\\\Qstarlord\\\\E"}}}}}]}}""", ["tags"]],
                [ "tags/all(t:endswith(t,'custom_string(web)') or endswith(t,'custom_string(trap)'))", """{"\$match": {"\$and": [{"\$expr": {"\$eq": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$or": [{"\$regexMatch": {"input": "\$\$t", "regex": "\\\\Qweb\\\\E\$"}}, {"\$regexMatch": {"input": "\$\$t", "regex": "\\\\Qtrap\\\\E\$"}}]}}}}, {"\$size": {"\$ifNull": ["\$tags", []]}}]}}]}}""", ["tags"]],
                [ "tags/all(t:contains(tolower(t),'custom_string(star)'))", """{"\$match": {"\$and": [{"\$expr": {"\$eq": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$regexMatch": {"input": {"\$toLower": "\$\$t"}, "regex": "\\\\Qstar\\\\E"}}}}}, {"\$size": {"\$ifNull": ["\$tags", []]}}]}}]}}""", ["tags"]],
                ...
                [ "tags/all(t:contains(toupper(t),'custom_string(STAR)'))", """{"\$match": {"\$and": [{"\$expr": {"\$eq": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$regexMatch": {"input": {"\$toUpper": "\$\$t"}, "regex": "\\\\QSTAR\\\\E"}}}}}, {"\$size": {"\$ifNull": ["\$tags", []]}}]}}]}}""", ["tags"]],
                ...
                [ "tags/all(t:startswith(t,'custom_string(star)') or t ne 'custom_string(starlord)')", """{"\$match": {"\$and": [{"\$expr": {"\$eq": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$or": [{"\$regexMatch": {"input": "\$\$t", "regex": "^\\\\Qstar\\\\E"}}, {"\$ne": ["\$\$t", "starlord"]}]}}}}, {"\$size": {"\$ifNull": ["\$tags", []]}}]}}]}}""", ["tags"]],
                [ "tags/all(t:startswith(t,'custom_string(star )') or t eq 'custom_string(starlord)')", """{"\$match": {"\$and": [{"\$expr": {"\$eq": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$or": [{"\$regexMatch": {"input": "\$\$t", "regex": "^\\\\Qstar \\\\E"}}, {"\$eq": ["\$\$t", "starlord"]}]}}}}, {"\$size": {"\$ifNull": ["\$tags", []]}}]}}]}}""", ["tags"]],
                ...
                [ "tags/any(t:contains(tolower(t),'custom_string(star)'))", """{"\$match": {"\$and": [{"\$expr": {"\$gt": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$regexMatch": {"input": {"\$toLower": "\$\$t"}, "regex": "\\\\Qstar\\\\E"}}}}}, 0]}}]}}""", ["tags"]],
                [ "tags/any(t:endswith(toupper(t),'custom_string(TRAP)'))", """{"\$match": {"\$and": [{"\$expr": {"\$gt": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$regexMatch": {"input": {"\$toUpper": "\$\$t"}, "regex": "\\\\QTRAP\\\\E\$"}}}}}, 0]}}]}}""", ["tags"]],
                ...
                [ "tags/any(t:startswith(t,'custom_string(dev)') and length(t) eq 9)", """{"\$match": {"\$and": [{"\$expr": {"\$gt": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$and": [{"\$regexMatch": {"input": "\$\$t", "regex": "^\\\\Qdev\\\\E"}}, {"\$eq": [{"\$strLenCP": "\$\$t"}, 9]}]}}}}, 0]}}]}}""", ["tags"]],
                ...
                [ "tags/any(t:startswith(t,'custom_string(spider)') and endswith(t, 'custom_string(web)'))", """{"\$match": {"\$and": [{"\$expr": {"\$gt": [{"\$size": {"\$filter": {"input": {"\$ifNull": ["\$tags", []]}, "as": "t", "cond": {"\$and": [{"\$regexMatch": {"input": "\$\$t", "regex": "^\\\\Qspider\\\\E"}}, {"\$regexMatch": {"input": "\$\$t", "regex": "\\\\Qweb\\\\E\$"}}]}}}}, 0]}}]}}""", ["tags"]],
