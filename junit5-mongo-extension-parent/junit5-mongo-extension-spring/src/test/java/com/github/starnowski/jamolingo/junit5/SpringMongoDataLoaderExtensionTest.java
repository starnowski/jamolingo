...
public class SpringMongoDataLoaderExtensionTest {
  ...
  public static Stream<Arguments> provideShouldAddDocumentsIntoCollections() {
    return Stream.of(
        Arguments.of(
  ...
  public void shouldClearCollections(
    ...
    SpringMongoDataLoaderExtension tested =
        new SpringMongoDataLoaderExtension() {
          @Override
    ...
    Mockito.when(extensionContext.getRequiredTestClass()).thenAnswer(invocation -> this.getClass());
    ...
    for (MongoCollectionKey collection : expectedEmptyCollections) {
      Assertions.assertEquals(
          ...
          String.format(
              ...
              collection.getDatabase(), collection.getCollection()));
    }
