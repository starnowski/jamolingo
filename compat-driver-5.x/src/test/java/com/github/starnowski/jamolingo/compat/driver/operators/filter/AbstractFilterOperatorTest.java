...
public abstract class AbstractFilterOperatorTest extends AbstractBaseFilterOperatorTest {
  ...
  protected void shouldReturnExpectedDocumentsBasedOnQueryObjectForFilterOperator(
    ...
    // WHEN
    FilterOperatorQueryObjectResult result = tested.parseQueryObject(uriInfo.getFilterOption());
    List<Document> results = collection.find(result.getQueryObject()).into(new ArrayList<>());
