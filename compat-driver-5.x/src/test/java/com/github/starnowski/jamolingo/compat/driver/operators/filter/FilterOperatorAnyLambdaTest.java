...
import static com.github.starnowski.jamolingo.compat.driver.operators.filter.FilterTestsCasesAggregator.provideShouldReturnExpectedProjectedDocumentForAnyLambda;
import static com.github.starnowski.jamolingo.compat.driver.operators.filter.FilterTestsCasesAggregator.provideShouldReturnExpectedProjectedDocumentForComplexListForAnyLambda;
...
public class FilterOperatorAnyLambdaTest extends AbstractFilterOperatorTest {
  ...
  private static Stream<Arguments> provideShouldReturnExpectedProjectedDocument() {
    return provideShouldReturnExpectedProjectedDocumentForAnyLambda();
  }

  private static Stream<Arguments> provideShouldReturnExpectedProjectedDocumentForComplexList() {
    return provideShouldReturnExpectedProjectedDocumentForComplexListForAnyLambda();
  }
}
