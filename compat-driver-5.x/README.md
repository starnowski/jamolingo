...
The primary goal of this module is to test the compatibility of the `core` module with the **MongoDB Java Driver version 5.x**.
...
*   **`junit5-mongo-extension`**: To manage MongoDB data loading and lifecycle during tests.
*   **`json` module**: To handle configuration overrides and dynamic mapping adjustments for specific test cases.
